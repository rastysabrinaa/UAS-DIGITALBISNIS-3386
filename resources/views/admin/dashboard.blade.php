...
<div class="bg-white p-8 rounded-3xl border border-slate-100 shadow-sm mb-10">
    <div class="mb-6">
        <h3 class="font-black text-xl text-slate-800">Grafik Pertumbuhan Platform</h3>
        <p class="text-xs text-slate-400 font-semibold mt-1">Tren pendaftaran pengguna baru vs penyelenggaraan event baru (6 Bulan Terakhir)</p>
    </div>
